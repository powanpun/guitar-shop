...
class ColorManager {
  static Color primary = HexColor.fromHex('#BD232E');
  static Color primaryLight = HexColor.fromHex('#FFF8DA');
  static Color blackBtnBg = HexColor.fromHex('#454545');
  static Color secondaryGreen = HexColor.fromHex('#47BB75');
  static Color secondaryYellow = HexColor.fromHex('#EAE10E');

  static Color darkGrey = HexColor.fromHex('#525252');
  static Color grey = HexColor.fromHex('#737477');
  static Color lightGrey = HexColor.fromHex('#EEEEEE');
  static Color lightGrey1 = HexColor.fromHex('#F6F6F6');
  static Color lightGrey2 = HexColor.fromHex('#ECECED');
  static Color lightGrey3 = HexColor.fromHex('#D9D9D9');
  static Color primaryOpacity70 = HexColor.fromHex('#C70000');
  static Color transparent = Colors.transparent;
  static Color skyBlue = HexColor.fromHex('##50AAE4');
  static Color skyBlue05 = HexColor.fromHex('#EFF9FF');
  static Color tunnerGrey = HexColor.fromHex('#7D7D7D');
  ...
  static Color brandItemBorder = HexColor.fromHex('#D0D0D0');
